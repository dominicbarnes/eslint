...
function loadConfig(filePath) {
    ...
    /* istanbul ignore else else should never be hit */
    if (filePath) {
...
function getPluginsConfig(pluginNames) {
    ...
    /* istanbul ignore else sanity check, should never happen */
    if (pluginNames) {
        pluginNames.forEach(function (pluginName) {
            ...
            /* istanbul ignore else too hard to test through unittests */
...
function getPersonalConfig() {
    ...
    /* istanbul ignore next Too hard to test configs in user folder */
...
Config.prototype.getConfig = function (filePath) {
    ...
    /* istanbul ignore else env is always set to either command line or empty object */
